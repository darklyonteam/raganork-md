...
const baseConfig = {
  ...
  BOT_INFO: process.env.BOT_INFO || "Somebody;Something;default",
  RBG_KEY: process.env.RBG_KEY || "",
  ALLOWED: process.env.ALLOWED || "94",
  NOT_ALLOWED: process.env.NOT_ALLOWED || "852",
  CHATBOT: process.env.CHATBOT || "off",
  HANDLERS: process.env.HANDLERS || ".,",
  STICKER_DATA: process.env.STICKER_DATA || "Somebody",
  BOT_NAME: process.env.BOT_NAME || "Something",
  AUDIO_DATA:
  ...
  SUPPORT_GROUP: process.env.SUPPORT_GROUP || "Someway",
